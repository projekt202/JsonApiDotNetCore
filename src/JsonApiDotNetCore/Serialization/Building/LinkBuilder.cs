...
namespace JsonApiDotNetCore.Serialization.Building
{
    ...
    public class LinkBuilder : ILinkBuilder
    {
        ...
        private string GetLinkForPagination(int pageOffset, string pageSizeValue)
        {
            ...
            if (!_options.UseRelativeLinks)
            {
                linkBuilder.Append(_httpContextAccessor.HttpContext.Request.Scheme);
                linkBuilder.Append("://");
                linkBuilder.Append(_httpContextAccessor.HttpContext.Request.Host);
            }

            linkBuilder.Append(_httpContextAccessor.HttpContext.Request.PathBase);
            linkBuilder.Append(_httpContextAccessor.HttpContext.Request.Path);

            string queryStringValue = QueryString.Create(parameters).Value;
            queryStringValue = DecodeSpecialCharacters(queryStringValue);
            linkBuilder.Append(queryStringValue);
        ...
        private string GetLinkForResourceSelf(ResourceContext resourceContext, string resourceId)
        {
            ...
            return _options.UseRelativeLinks
                ? _linkGenerator.GetPathByAction(_httpContextAccessor.HttpContext, GetPrimaryControllerAction, controllerName, routeData)
                : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, GetPrimaryControllerAction, controllerName, routeData);
        }
        ...
        private string GetLinkForRelationshipSelf(string primaryId, RelationshipAttribute relationship)
        {
            ...
            return _options.UseRelativeLinks
                ? _linkGenerator.GetPathByAction(_httpContextAccessor.HttpContext, GetRelationshipControllerAction, controllerName, routeData)
                : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, GetRelationshipControllerAction, controllerName, routeData);
        }
        ...
        private string GetLinkForRelationshipRelated(string primaryId, RelationshipAttribute relationship)
        {
            ...
            return _options.UseRelativeLinks
                ? _linkGenerator.GetPathByAction(_httpContextAccessor.HttpContext, GetSecondaryControllerAction, controllerName, routeData)
                : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, GetSecondaryControllerAction, controllerName, routeData);
        }
